...
Rcpp::List calculate_transcript_mc(Rcpp::IntegerVector absoluteHits, Rcpp::IntegerVector totalSites, double relHitsForeground, int n, int maxPermutations, int minPermutations, int e);
...
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type absoluteHits(absoluteHitsSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type totalSites(totalSitesSEXP);
